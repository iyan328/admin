...
<head>
  ...
  <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css"> -->
      ...
      <link rel="stylesheet" href="../dosenp/css/style.css">
	  <link rel="stylesheet" href="../dosenp/css/normalize.min.css">
</head>
...
<body>
  <div class="form">
      ...
      <ul class="tab-group">
        ...
        <div id="signup">   
          ...
          <form action="../login/loginadmin.php?op=in" method="post">
  ...
  <!-- <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script> -->
		<script src="../dosenp/js/jquery.min.js"></script>
      <script src="../dosenp/js/index.js"></script>
